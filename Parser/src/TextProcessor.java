...
public class TextProcessor {
	 ...
	 * indentation level.
	 */
	public List<String[]> checkScanner() throws FileNotFoundException {
		int open = 0;
	...
	public List<String[]> checkBracketCount() throws FileNotFoundException, IOException {
	...
	public List<String[]> checkBracketMatch() throws FileNotFoundException, IOException {
	...
	public List<String[]> checkBadSemiColon() throws FileNotFoundException, IOException {
	...
	public List<String[]> checkAssignment() throws FileNotFoundException {
		int errorCount = 0;
		ArrayList<String[]> errors = new ArrayList<String[]>();
	...
	public List<String[]> checkTabbing(int numSpaces) throws IOException { // #dablife #maverickmerch
												// #itslitfam
		ArrayList<String[]> errors = new ArrayList<String[]>();
		int errorCount = 0;
		int level = 0;
